    ...
    <div class="formDiv">
        <form action="signinform.php" method="post">
            ...
            <div class="input">
                ...
                <br>
                <input id="query" type="text" name="postalcode" onfocusout= "zoeknu('signin');" placeholder="postalcode" autocomplete="nope" required>
                <br>
                <input type="text" name="house_number" placeholder="huisnummer" required>
                <br>
                <input type="checkbox" name="accept-phonenumber_input" value="true">Accepteer telefoon
                <input type="checkbox" name="accept-email_input" value="true" checked>Accepteer email
